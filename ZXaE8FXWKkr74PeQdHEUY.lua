...
local Themes = {
	...
	VolcanoHubXViolet = {
		...
		DropdownBorder = Color3.fromRGB(148, 0, 211),  
		DropdownOption = Color3.fromRGB(148, 0, 211),
		Keybind = Color3.fromRGB(148, 0, 211),  
		...
		DialogHolderLine = Color3.fromRGB(148, 0, 211),  
		DialogButton = Color3.fromRGB(30, 30, 45),
		DialogButtonBorder = Color3.fromRGB(148, 0, 211),  
		DialogBorder = Color3.fromRGB(70, 70, 90),
		DialogInput = Color3.fromRGB(40, 40, 60),
		DialogInputLine = Color3.fromRGB(148, 0, 211),  
...
local function AnimateAccentPulse(guiRoot, theme)
	...
	local colorA = Color3.fromRGB(220, 30,  30)   
	local colorB = Color3.fromRGB(140, 10,  10)   
	local PULSE_TIME = 1.8  
...
function Spring:step(state, dt)
	...
	elseif d < 1 then -- Underdamped
		...
		--    z Ã¢â€°Ë† a - (a^3*c^2)/6 + (a^5*c^4)/120
		-- Rewrite in Horner form:
		--    z Ã¢â€°Ë† a + ((a*a)*(c*c)*(c*c)/20 - c*c)*(a*a*a)/6
